			...
			<div id="user">
				...
				<form id="join-form" name="join-form" method="post"
					...
					<input type="hidden" name="a" value="join"> <label
						...
						name="name" type="text"> <img id="name-checked" src="/assets/images/check.png" style="display:none">
						<label class="block-label"
						for="email">이메일</label> <input id="email" name="email" type="text">
						<input type="button" value="id 중복체크">
						<img id="email-checked" src="/assets/images/check.png" style="display:none">
					 <label
						class="block-label">패스워드</label> <input id="password" name="password"
						type="password"> <img id="password-checked" src="/assets/images/check.png" style="display:none">
